...
MODIFY COLUMN role ENUM('dean', 'hod', 'staff_incharge', 'president', 'vice_president', 'technical_head', 'non_technical_head', 'management_head', 'photography_head', 'social_media_manager', 'domain_lead', 'accountant', 'student', 'member', 'core', 'lead') NOT NULL;
